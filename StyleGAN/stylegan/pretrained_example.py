...
def main():
    ...
    # Custom Modification of the above statement as I was facing Google Drive Quota Exceeded Error
    ...
    url = './results/00002-sgan-ffhq-1gpu/network-snapshot-004221.pkl'
