...
def setup_training_loop_kwargs(
    ...
    if cfg == 'auto':
        ...
        spec.mb = min(2,max(min(gpus * min(4096 // res, 32), 64), gpus)) # keep gpu memory consumption at bay
        spec.mbstd = min(spec.mb // gpus, 2) # other hyperparams behave more predictably if mbstd group size remains fixed
